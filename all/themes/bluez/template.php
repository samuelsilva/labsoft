...
/*  $base_path = 'http://localhost/labsoft/';
  ...
  $output .= '<a class="menu-button" title="Link para processos correntes" href="'.$base_path.'processos/processo_corrente"><img class="icon" src="'.$base_path.'/'.drupal_get_path('theme', $GLOBALS['theme']).'/images/pencil.png"><br/>Corrente</a>';
  $output .= '<a class="menu-button" title="Link para processos arquivados" href="'.$base_path.'processos/processo_arquivado"><img class="icon" src="'.$base_path.'/'.drupal_get_path('theme', $GLOBALS['theme']).'/images/search.png"><br/>Arquivado</a>';
