...
<<<<<<< HEAD
        ...
        <a class="menu-button" title="Pesquise os itens cadastrados nesta parte do sistema" href="/drupal/content/pesquisar"><img class="icon" src="<?php echo $base_path.'/'.drupal_get_path('theme', $GLOBALS['theme']); ?>/images/search.png"><br/>Pesquisar</a>
...
>>>>>>> 5c10e9fbf4530c0720a3c3f02eb7b6f9f76db641
    <?php
